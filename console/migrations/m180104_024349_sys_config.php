...
class m180104_024349_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
...
1:开启','remark'=>'站点关闭全部用户不能访问','value'=>'1','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1378898976','updated'=>'1501730648']);
        $this->insert('{{%sys_config}}',['id'=>'5','title'=>'网站备案号','type'=>'text','name'=>'WEB_SITE_ICP','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'设置在网站底部显示的备案号，如“沪ICP备12007941号-2','value'=>'','is_hide_remark'=>'0','sort'=>'7','status'=>'1','append'=>'1378900335','updated'=>'1513853656']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'53','title'=>'AppId','type'=>'text','name'=>'WECHAT_APPID','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppId','value'=>'','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1481597992','updated'=>'1514525669']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'54','title'=>'AppSecret','type'=>'text','name'=>'WECHAT_APPSERCRET','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppSecret, 只有填写这两项才能管理自定义菜单','value'=>'','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1481598058','updated'=>'1514525669']);
        $this->insert('{{%sys_config}}',['id'=>'55','title'=>'Token','type'=>'secretKeyText','name'=>'WECHAT_TOKEN','cate'=>'3','cate_child'=>'19','extra'=>'32','remark'=>'与公众平台接入设置值一致，必须为英文或者数字，长度为3到32个字符. 请妥善保管, Token 泄露将可能被窃取或篡改平台的操作数据.','value'=>'','is_hide_remark'=>'0','sort'=>'5','status'=>'1','append'=>'1481598165','updated'=>'1514525669']);
...
','value'=>'','is_hide_remark'=>'0','sort'=>'6','status'=>'1','append'=>'1481598229','updated'=>'1501465722']);
        $this->insert('{{%sys_config}}',['id'=>'61','title'=>'支付商户号','type'=>'text','name'=>'WECHAT_MCHID','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'公众号支付请求中用于加密的密钥Key','value'=>'','is_hide_remark'=>'0','sort'=>'1','status'=>'1','append'=>'1484010596','updated'=>'1514525701']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'62','title'=>'支付密钥','type'=>'text','name'=>'WECHAT_API_KEY','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'此值需要手动在腾讯商户后台API密钥保持一致。','value'=>'','is_hide_remark'=>'0','sort'=>'2','status'=>'1','append'=>'1484010645','updated'=>'1514525702']);
...
2:不限','remark'=>'如果选择不限会显示全部菜单，选择有权限菜单则只会显示用户权限对应的菜单','value'=>'1','is_hide_remark'=>'0','sort'=>'2','status'=>'1','append'=>'1492360156','updated'=>'1501634806']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'89','title'=>'SMTP服务器','type'=>'text','name'=>'MAILER_HOST','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'例如:smtp.163.com','value'=>'','is_hide_remark'=>'0','sort'=>'0','status'=>'1','append'=>'1492705455','updated'=>'1497230983']);
