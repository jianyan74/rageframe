...
class m171010_060051_sys_auth_item extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_rule_3325_00','{{%sys_auth_item}}', 'rule_name', '{{%sys_auth_rule}}', 'name', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/rule/index','type'=>'2','key'=>'42','description'=>'自动回复','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'39','level'=>'1','sort'=>'0','created_at'=>'1499591959','updated_at'=>'1501627165']);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'测试2','type'=>'1','key'=>'59','description'=>'admin|添加了|测试2|角色','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'0','level'=>'1','sort'=>'0','created_at'=>'1506318860','updated_at'=>NULL]);
        $this->insert('{{%sys_auth_item}}',['name'=>'测试用户','type'=>'1','key'=>'16','description'=>'admin|添加了|测试用户|角色','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'0','level'=>'1','sort'=>'0','created_at'=>'1499405333','updated_at'=>'1501045142']);
