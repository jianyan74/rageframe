...
class m170919_082340_sys_article_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_article_cate}}',['cate_id'=>'1','title'=>'测','pid'=>'0','sort'=>'0','status'=>'1','level'=>'1','group'=>'0','append'=>'1501464921','updated'=>'1501464928']);
