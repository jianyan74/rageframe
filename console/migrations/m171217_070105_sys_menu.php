...
class m171217_070105_sys_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_menu}}',['id'=>'1','title'=>'系统管理','pid'=>'0','url'=>'menu-sys','menu_css'=>'fa-cogs','sort'=>'1','status'=>'1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1460353610','updated'=>'1507792680']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'13','title'=>'网站设置','pid'=>'1','url'=>'sys/config/edit-all','menu_css'=>'','sort'=>'0','status'=>'1','level'=>'2','dev'=>'0','type'=>'menu','append'=>'1470970402','updated'=>'1507960932']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'19','title'=>'会员管理','pid'=>'0','url'=>'menu-user','menu_css'=>'fa-user','sort'=>'2','status'=>'1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1477451201','updated'=>'1501730523']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'24','title'=>'内容管理','pid'=>'0','url'=>'menu-article','menu_css'=>'fa-bars','sort'=>'3','status'=>'1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1477709532','updated'=>'1501730524']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'34','title'=>'粉丝标签','pid'=>'32','url'=>'wechat/fans-groups/list','menu_css'=>'','sort'=>'1','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596119','updated'=>'1510106609']);
        $this->insert('{{%sys_menu}}',['id'=>'36','title'=>'素材库','pid'=>'30','url'=>'wechat/attachment/news-index','menu_css'=>'','sort'=>'3','status'=>'1','level'=>'2','dev'=>'0','type'=>'menu','append'=>'1481596234','updated'=>'1500694814']);
        $this->insert('{{%sys_menu}}',['id'=>'37','title'=>'数据统计','pid'=>'30','url'=>'#','menu_css'=>'','sort'=>'7','status'=>'1','level'=>'2','dev'=>'0','type'=>'menu','append'=>'1481596253','updated'=>'1509513973']);
        $this->insert('{{%sys_menu}}',['id'=>'39','title'=>'回复规则使用量','pid'=>'37','url'=>'wechat/stat/rule','menu_css'=>'','sort'=>'2','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596305','updated'=>'1509514004']);
        $this->insert('{{%sys_menu}}',['id'=>'40','title'=>'关键字命中规则','pid'=>'37','url'=>'wechat/stat/rule-keyword','menu_css'=>'','sort'=>'3','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596321','updated'=>'1509524225']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'49','title'=>'多客服接入','pid'=>'31','url'=>'#','menu_css'=>'','sort'=>'3','status'=>'-1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596716','updated'=>'1501730528']);
        $this->insert('{{%sys_menu}}',['id'=>'50','title'=>'消息管理','pid'=>'32','url'=>'wechat/msg-history/index','menu_css'=>'','sort'=>'6','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596835','updated'=>'1508988059']);
        $this->insert('{{%sys_menu}}',['id'=>'62','title'=>'参数设置','pid'=>'30','url'=>'/wechat/setting/history-stat','menu_css'=>'','sort'=>'8','status'=>'1','level'=>'2','dev'=>'0','type'=>'menu','append'=>'1487726086','updated'=>'1508989287']);
        $this->insert('{{%sys_menu}}',['id'=>'65','title'=>'扩展模块','pid'=>'0','url'=>'sys/addons/index','menu_css'=>'fa-cubes','sort'=>'10','status'=>'1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1488285719','updated'=>'1501730540']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'70','title'=>'数据备份','pid'=>'68','url'=>'data-base/backups','menu_css'=>'fa-database','sort'=>'0','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1491105328','updated'=>'1510832350']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'72','title'=>'服务器信息及日志','pid'=>'0','url'=>'sys-manager','menu_css'=>'','sort'=>'4','status'=>'1','level'=>'1','dev'=>'0','type'=>'sys','append'=>'1491113016','updated'=>'1508405267']);
        $this->insert('{{%sys_menu}}',['id'=>'78','title'=>'系统信息','pid'=>'72','url'=>'system/info','menu_css'=>'fa-exclamation','sort'=>'1','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1492316037','updated'=>'1508218709']);
        $this->insert('{{%sys_menu}}',['id'=>'79','title'=>'系统日志','pid'=>'72','url'=>'action-log/index','menu_css'=>'fa-file-text','sort'=>'0','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1492326226','updated'=>'1508218709']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'82','title'=>'配置管理','pid'=>'93','url'=>'config/index','menu_css'=>'fa-gear','sort'=>'2','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1492345718','updated'=>'1501797642']);
        $this->insert('{{%sys_menu}}',['id'=>'83','title'=>'后台菜单','pid'=>'93','url'=>'menu/index','menu_css'=>'fa-list','sort'=>'3','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1492345776','updated'=>'1501797643']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'106','title'=>'自动回复','pid'=>'31','url'=>'wechat/rule/index','menu_css'=>'','sort'=>'0','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1493358892','updated'=>'1501462520']);
        $this->insert('{{%sys_menu}}',['id'=>'108','title'=>'功能插件','pid'=>'0','url'=>'menu-plug-in','menu_css'=>'fa-windows','sort'=>'9','status'=>'1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1495966938','updated'=>'1501730539']);
        $this->insert('{{%sys_menu}}',['id'=>'112','title'=>'小程序','pid'=>'0','url'=>'sys/wxapp/index','menu_css'=>'fa-code','sort'=>'11','status'=>'-1','level'=>'1','dev'=>'0','type'=>'menu','append'=>'1501796969','updated'=>'1501802519']);
        $this->insert('{{%sys_menu}}',['id'=>'113','title'=>'小程序','pid'=>'93','url'=>'wx-app/index','menu_css'=>'fa-code','sort'=>'1','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1501797662','updated'=>'1501899792']);
        $this->insert('{{%sys_menu}}',['id'=>'115','title'=>'规则管理','pid'=>'86','url'=>'auth-rule/index','menu_css'=>'fa-gavel','sort'=>'3','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1507955145','updated'=>'1507955145']);
        $this->insert('{{%sys_menu}}',['id'=>'116','title'=>'服务器信息','pid'=>'72','url'=>'system/server','menu_css'=>'fa-microchip','sort'=>'2','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1507993299','updated'=>'1507993819']);
        $this->insert('{{%sys_menu}}',['id'=>'117','title'=>'粉丝关注统计','pid'=>'37','url'=>'wechat/stat/fans-follow','menu_css'=>'','sort'=>'1','status'=>'1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1509280144','updated'=>'1509525759']);
