...
class m170822_071418_sys_addons_binding extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_addons_binding}}',['id'=>'28','addons_name'=>'Debris','entry'=>'menu','title'=>'碎片列表','route'=>'debris/index','icon'=>'']);
        ...
        $this->insert('{{%sys_addons_binding}}',['id'=>'36','addons_name'=>'AppManual','entry'=>'cover','title'=>'文档入口','route'=>'manual/index','icon'=>'']);
        $this->insert('{{%sys_addons_binding}}',['id'=>'37','addons_name'=>'AppManual','entry'=>'menu','title'=>'文档管理','route'=>'manual/index','icon'=>'']);
        ...
        $this->insert('{{%sys_addons_binding}}',['id'=>'44','addons_name'=>'LeaveMessage','entry'=>'menu','title'=>'留言管理','route'=>'leave-message/index','icon'=>'']);
