...
class m171027_034127_sys_config_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_config_cate}}', [
            ...
            'status' => 'tinyint(4) NULL DEFAULT \'1\' COMMENT \'是否隐藏\'',
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'8','title'=>'支付宝手机','pid'=>'4','level'=>'2','sort'=>'0','status'=>'1','append'=>'1497177218','updated'=>'1497248415']);
        $this->insert('{{%sys_config_cate}}',['id'=>'9','title'=>'微信','pid'=>'4','level'=>'2','sort'=>'0','status'=>'1','append'=>'1497177226','updated'=>'1497177406']);
        $this->insert('{{%sys_config_cate}}',['id'=>'10','title'=>'银联','pid'=>'4','level'=>'2','sort'=>'0','status'=>'-1','append'=>'1497177235','updated'=>'1497247812']);
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'17','title'=>'网站配置','pid'=>'1','level'=>'2','sort'=>'0','status'=>'1','append'=>'1497177421','updated'=>'1507960988']);
