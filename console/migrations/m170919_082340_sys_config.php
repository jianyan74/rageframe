...
class m170919_082340_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
...
1:开启','remark'=>'站点关闭全部用户不能访问','status'=>'1','value'=>'1','sort'=>'4','is_hide_remark'=>'0','append'=>'1378898976','updated'=>'1501730648']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'50','name'=>'WECHAT_ACCOUTN','type'=>'1','title'=>'公众号帐号','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'填写公众号的帐号，一般为英文帐号','status'=>'1','value'=>'13484261295@163.com','sort'=>'0','is_hide_remark'=>'0','append'=>'1481597325','updated'=>'1497231224']);
        $this->insert('{{%sys_config}}',['id'=>'53','name'=>'WECHAT_APPID','type'=>'1','title'=>'AppId','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppId','status'=>'1','value'=>'wxd83b527cb7caf5ef','sort'=>'3','is_hide_remark'=>'0','append'=>'1481597992','updated'=>'1501330323']);
        $this->insert('{{%sys_config}}',['id'=>'57','name'=>'WECHAT_ID','type'=>'1','title'=>'原始ID','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'在给粉丝发送客服消息时,原始ID不能为空。建议您完善该选项','status'=>'1','value'=>' gh_bf77af9606e2','sort'=>'1','is_hide_remark'=>'0','append'=>'1481598297','updated'=>'1497231228']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'54','name'=>'WECHAT_APPSERCRET','type'=>'1','title'=>'AppSecret','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppSecret, 只有填写这两项才能管理自定义菜单','status'=>'1','value'=>'8d748ac890d7d0c871194b2a38098b16','sort'=>'4','is_hide_remark'=>'0','append'=>'1481598058','updated'=>'1501330323']);
        $this->insert('{{%sys_config}}',['id'=>'55','name'=>'WECHAT_TOKEN','type'=>'3','title'=>'Token','cate'=>'3','cate_child'=>'19','extra'=>'32','remark'=>'与公众平台接入设置值一致，必须为英文或者数字，长度为3到32个字符. 请妥善保管, Token 泄露将可能被窃取或篡改平台的操作数据.','status'=>'1','value'=>'e1bise2awoc5cb4ka40x3ov1b40ucwc5','sort'=>'5','is_hide_remark'=>'0','append'=>'1481598165','updated'=>'1501465722']);
...
','status'=>'1','value'=>'yEc9ZNoEaE8v1S9se18haMcjVT8n9Am88oHSlaEkh8t','sort'=>'6','is_hide_remark'=>'0','append'=>'1481598229','updated'=>'1501465722']);
...
2:不限','remark'=>'如果选择不限会显示全部菜单，选择有权限菜单则只会显示用户权限对应的菜单','status'=>'1','value'=>'1','sort'=>'2','is_hide_remark'=>'0','append'=>'1492360156','updated'=>'1501634806']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'89','name'=>'MAILER_HOST','type'=>'1','title'=>'SMTP服务器','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'例如:smtp.163.com','status'=>'1','value'=>'smtp.163.com','sort'=>'0','is_hide_remark'=>'0','append'=>'1492705455','updated'=>'1497230983']);
        $this->insert('{{%sys_config}}',['id'=>'90','name'=>'MAILER_USERNAME','type'=>'1','title'=>'SMTP帐号','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'例如:mobile@163.com','status'=>'1','value'=>'13484261295@163.com','sort'=>'1','is_hide_remark'=>'0','append'=>'1492705498','updated'=>'1501466132']);
        $this->insert('{{%sys_config}}',['id'=>'91','name'=>'MAILER_PASSWORD','type'=>'2','title'=>'SMTP客户端授权码','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'如果是163邮箱，此处要填授权码','status'=>'1','value'=>'test123456','sort'=>'2','is_hide_remark'=>'0','append'=>'1492705543','updated'=>'1497230995']);
        $this->insert('{{%sys_config}}',['id'=>'92','name'=>'MAILER_PORT','type'=>'1','title'=>'SMTP端口','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'25、109、110、143、465、995、993','status'=>'1','value'=>'465','sort'=>'3','is_hide_remark'=>'0','append'=>'1492705597','updated'=>'1501466118']);
        $this->insert('{{%sys_config}}',['id'=>'95','name'=>'MAILER_NAME','type'=>'1','title'=>'发件人名称','cate'=>'6','cate_child'=>'16','extra'=>'','remark'=>'例如:RageFrame','status'=>'1','value'=>'rageframe','sort'=>'5','is_hide_remark'=>'0','append'=>'1493707723','updated'=>'1501466230']);
