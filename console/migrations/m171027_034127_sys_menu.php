...
class m171027_034127_sys_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_menu}}',['id'=>'37','title'=>'数据统计','pid'=>'30','url'=>'#','menu_css'=>'','sort'=>'7','status'=>'-1','level'=>'2','dev'=>'0','type'=>'menu','append'=>'1481596253','updated'=>'1508989306']);
        $this->insert('{{%sys_menu}}',['id'=>'39','title'=>'回复规则使用量','pid'=>'37','url'=>'#','menu_css'=>'','sort'=>'2','status'=>'-1','level'=>'3','dev'=>'0','type'=>'menu','append'=>'1481596305','updated'=>'1501730537']);
        ...
        $this->insert('{{%sys_menu}}',['id'=>'70','title'=>'数据备份','pid'=>'68','url'=>'data-base/backups','menu_css'=>'fa-database','sort'=>'0','status'=>'1','level'=>'2','dev'=>'0','type'=>'sys','append'=>'1491105328','updated'=>'1507901597']);
