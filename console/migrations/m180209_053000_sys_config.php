...
class m180209_053000_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
...
1:开启','remark'=>'站点关闭全部用户不能访问','value'=>'1','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1378898976','updated'=>'1501730648']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'53','title'=>'AppId','type'=>'text','name'=>'WECHAT_APPID','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppId','value'=>'','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1481597992','updated'=>'1515392671']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'54','title'=>'AppSecret','type'=>'text','name'=>'WECHAT_APPSERCRET','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppSecret, 只有填写这两项才能管理自定义菜单','value'=>'','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1481598058','updated'=>'1515392671']);
...
1:开启','remark'=>'修改后需要刷新后台才能看到效果','value'=>'1','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1501730637','updated'=>'1506492330']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'109','title'=>'EndPoint','type'=>'text','name'=>'STORAGE_ALI_ENDPOINT','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','value'=>'oss-cn-shanghai.aliyuncs.com','is_hide_remark'=>'1','sort'=>'3','status'=>'1','append'=>'1506748837','updated'=>'1506756063']);
