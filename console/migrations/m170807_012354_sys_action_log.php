...
class m170807_012354_sys_action_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_action_log}}',['id'=>'17','action'=>'login','manager_id'=>'1','username'=>'admin','action_ip'=>'2130706433','model'=>'manager','record_id'=>'0','log_url'=>'/backend/site/login.html','remark'=>NULL,'country'=>NULL,'province'=>NULL,'city'=>NULL,'district'=>NULL,'status'=>'1','append'=>'1501638544']);
