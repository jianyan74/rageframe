...
class m180104_024348_sys_action_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_action_log}}',['id'=>'36','action'=>'login','manager_id'=>'1','username'=>'admin','action_ip'=>'2130706433','model'=>'manager','record_id'=>'0','log_url'=>'/backend/site/login.html','remark'=>NULL,'country'=>'','province'=>'','city'=>'','district'=>'','status'=>'1','append'=>'1515033714']);
