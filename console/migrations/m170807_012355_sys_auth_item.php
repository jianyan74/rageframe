...
class m170807_012355_sys_auth_item extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_rule_7296_00','{{%sys_auth_item}}', 'rule_name', '{{%sys_auth_rule}}', 'name', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'other','type'=>'2','key'=>'1','description'=>'其他公用','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'0','level'=>'1','sort'=>'0','created_at'=>'1499401238','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/article/edit','type'=>'2','key'=>'26','description'=>'编辑新增','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'19','level'=>'3','sort'=>'0','created_at'=>'1499590946','updated_at'=>NULL]);
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/article/hide','type'=>'2','key'=>'28','description'=>'文章删除','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'19','level'=>'3','sort'=>'1','created_at'=>'1499591145','updated_at'=>NULL]);
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/article/index','type'=>'2','key'=>'19','description'=>'文章管理','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'17','level'=>'2','sort'=>'1','created_at'=>'1499590444','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/cache/clear','type'=>'2','key'=>'5','description'=>'清理缓存','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'1','level'=>'2','sort'=>'2','created_at'=>'1499403715','updated_at'=>'1499403724']);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/manager/personal','type'=>'2','key'=>'3','description'=>'个人中心','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'1','level'=>'2','sort'=>'0','created_at'=>'1499403567','updated_at'=>'1499403645']);
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/manager/up-passwd','type'=>'2','key'=>'4','description'=>'修改密码','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'1','level'=>'2','sort'=>'1','created_at'=>'1499403686','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/attachment/get-all-attachment','type'=>'2','key'=>'59','description'=>'素材同步','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'41','level'=>'2','sort'=>'1','created_at'=>'1501041169','updated_at'=>NULL]);
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/attachment/image-index','type'=>'2','key'=>'58','description'=>'图片管理','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'41','level'=>'2','sort'=>'0','created_at'=>'1501041076','updated_at'=>NULL]);
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/attachment/news-index','type'=>'2','key'=>'41','description'=>'素材库(图文素材)','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'36','level'=>'1','sort'=>'2','created_at'=>'1499591807','updated_at'=>'1501041202']);
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/custom-menu/edit','type'=>'2','key'=>'57','description'=>'菜单删除','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'43','level'=>'4','sort'=>'1','created_at'=>'1499593431','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/reply-news/edit','type'=>'2','key'=>'60','description'=>'编辑新增图文','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'42','level'=>'4','sort'=>'2','created_at'=>'1501041286','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/reply/index','type'=>'2','key'=>'42','description'=>'自动回复','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'39','level'=>'3','sort'=>'0','created_at'=>'1499591959','updated_at'=>NULL]);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'测试','type'=>'1','key'=>'16','description'=>'admin|添加了|测试|角色','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'0','level'=>'1','sort'=>'0','created_at'=>'1499405333','updated_at'=>'1499405338']);
