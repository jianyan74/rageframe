...
class m171010_060051_sys_config_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_config_cate}}',['id'=>'21','title'=>'阿里云OSS','pid'=>'7','sort'=>'1','status'=>'1','level'=>'2','append'=>'1506747965','updated'=>'1506747965']);
        $this->insert('{{%sys_config_cate}}',['id'=>'22','title'=>'分享配置','pid'=>'3','sort'=>'1','status'=>'1','level'=>'2','append'=>'1506755826','updated'=>'1506755826']);
