...
class m180104_024348_sys_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_addons}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统_插件表'");
        ...
        /* 表数据 */
        $this->insert('{{%sys_addons}}',['id'=>'76','name'=>'AppExample','title'=>'示例管理','cover'=>'','group'=>'','type'=>'plug','brief_introduction'=>'系统的功能示例','description'=>'系统自带的功能使用示例及其说明，包含一些简单的交互','config'=>NULL,'setting'=>'0','hook'=>'1','author'=>'简言','version'=>'1.0','title_initial'=>'S','wechat_message'=>'a:0:{}','is_rule'=>'0','wxapp_support'=>'0','status'=>'1','append'=>'1509345642','updated'=>'1513928048']);
