...
class m180209_052959_sys_addons_binding extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_addons_binding}}',['id'=>'224','addons_name'=>'AppExample','entry'=>'menu','title'=>'基本表格','route'=>'curd-base/index','icon'=>'']);
        $this->insert('{{%sys_addons_binding}}',['id'=>'225','addons_name'=>'AppExample','entry'=>'menu','title'=>'Grid表格','route'=>'curd-grid/index','icon'=>'']);
