...
class m171010_060051_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
...
1:开启','remark'=>'站点关闭全部用户不能访问','status'=>'1','value'=>'1','sort'=>'4','is_hide_remark'=>'0','append'=>'1378898976','updated'=>'1501730648']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'53','name'=>'WECHAT_APPID','type'=>'1','title'=>'AppId','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppId','status'=>'1','value'=>'','sort'=>'3','is_hide_remark'=>'0','append'=>'1481597992','updated'=>'1506057451']);
        $this->insert('{{%sys_config}}',['id'=>'57','name'=>'WECHAT_ID','type'=>'1','title'=>'原始ID','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'在给粉丝发送客服消息时,原始ID不能为空。建议您完善该选项','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'0','append'=>'1481598297','updated'=>'1505992643']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'54','name'=>'WECHAT_APPSERCRET','type'=>'1','title'=>'AppSecret','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppSecret, 只有填写这两项才能管理自定义菜单','status'=>'1','value'=>'','sort'=>'4','is_hide_remark'=>'0','append'=>'1481598058','updated'=>'1505992643']);
        $this->insert('{{%sys_config}}',['id'=>'55','name'=>'WECHAT_TOKEN','type'=>'3','title'=>'Token','cate'=>'3','cate_child'=>'19','extra'=>'32','remark'=>'与公众平台接入设置值一致，必须为英文或者数字，长度为3到32个字符. 请妥善保管, Token 泄露将可能被窃取或篡改平台的操作数据.','status'=>'1','value'=>'','sort'=>'5','is_hide_remark'=>'0','append'=>'1481598165','updated'=>'1505992643']);
...
','status'=>'1','value'=>'','sort'=>'6','is_hide_remark'=>'0','append'=>'1481598229','updated'=>'1501465722']);
        $this->insert('{{%sys_config}}',['id'=>'61','name'=>'WECHAT_MCHID','type'=>'1','title'=>'支付商户号','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'公众号支付请求中用于加密的密钥Key','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'0','append'=>'1484010596','updated'=>'1506756043']);
        $this->insert('{{%sys_config}}',['id'=>'60','name'=>'WECHAT_IS_PAY','type'=>'6','title'=>'是否开启','cate'=>'4','cate_child'=>'9','extra'=>'0:关闭,1:开启','remark'=>'你必须向微信公众平台提交企业信息以及银行账户资料，审核通过并签约后才能使用微信支付功能,<a href=\"https://mp.weixin.qq.com/paymch/readtemplate?t=mp/business/faq_tmpl\" target=\"_blank\">申请及详情请查看这里</a>','status'=>'1','value'=>'1','sort'=>'0','is_hide_remark'=>'0','append'=>'1484010415','updated'=>'1506756040']);
        $this->insert('{{%sys_config}}',['id'=>'62','name'=>'WECHAT_API_KEY','type'=>'1','title'=>'支付密钥','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'此值需要手动在腾讯商户后台API密钥保持一致。','status'=>'1','value'=>'','sort'=>'2','is_hide_remark'=>'0','append'=>'1484010645','updated'=>'1506756043']);
        $this->insert('{{%sys_config}}',['id'=>'63','name'=>'WECHAT_APICLIENT_CERT','type'=>'1','title'=>'支付证书','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'请填写证书绝对路径','status'=>'1','value'=>'','sort'=>'3','is_hide_remark'=>'0','append'=>'1484012102','updated'=>'1506756044']);
        $this->insert('{{%sys_config}}',['id'=>'64','name'=>'WECHAT_APICLIENT_KEY','type'=>'1','title'=>'支付证书私钥','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'请填写私钥绝对路径','status'=>'1','value'=>'','sort'=>'4','is_hide_remark'=>'0','append'=>'1484012169','updated'=>'1506756045']);
...
','remark'=>'每页显示记录的数量','status'=>'1','value'=>'10','sort'=>'0','is_hide_remark'=>'0','append'=>'1486631131','updated'=>'1497239638']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'96','name'=>'WECHAT_QR_CODE','type'=>'8','title'=>'二维码','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'微信关注二维码','status'=>'1','value'=>NULL,'sort'=>'7','is_hide_remark'=>'0','append'=>'1495421613','updated'=>'1497231279']);
...
2:不限','remark'=>'如果选择不限会显示全部菜单，选择有权限菜单则只会显示用户权限对应的菜单','status'=>'1','value'=>'1','sort'=>'2','is_hide_remark'=>'0','append'=>'1492360156','updated'=>'1501634806']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'87','name'=>'WEIBO_CLIENT_APPID','type'=>'1','title'=>'AppId','cate'=>'5','cate_child'=>'12','extra'=>'','remark'=>'应用的唯一标识。在OAuth2.0认证过程中，appid的值即为oauth_consumer_key的值','status'=>'1','value'=>'','sort'=>'0','is_hide_remark'=>'0','append'=>'1492703971','updated'=>'1506756049']);
        $this->insert('{{%sys_config}}',['id'=>'88','name'=>'WEIBO_CLIENT_APPKEY','type'=>'1','title'=>'AppKey','cate'=>'5','cate_child'=>'12','extra'=>'','remark'=>'appid对应的密钥，访问用户资源时用来验证应用的合法性。在OAuth2.0认证过程中，appkey的值即为oauth_consumer_secret的值','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'0','append'=>'1492704022','updated'=>'1506756050']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'97','name'=>'GITHUB_CLIENT_APPID','type'=>'1','title'=>'AppId','cate'=>'5','cate_child'=>'14','extra'=>'','remark'=>'应用的唯一标识。在OAuth2.0认证过程中，appid的值即为oauth_consumer_key的值','status'=>'1','value'=>'','sort'=>'0','is_hide_remark'=>'0','append'=>'1495441085','updated'=>'1506756053']);
        $this->insert('{{%sys_config}}',['id'=>'98','name'=>'GITHUB_CLIENT_APPKEY','type'=>'1','title'=>'AppKey','cate'=>'5','cate_child'=>'14','extra'=>'','remark'=>'appid对应的密钥，访问用户资源时用来验证应用的合法性。在OAuth2.0认证过程中，appkey的值即为oauth_consumer_secret的值','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'0','append'=>'1495441133','updated'=>'1506756054']);
        $this->insert('{{%sys_config}}',['id'=>'100','name'=>'WEIXIN_CLIENT_APPKEY','type'=>'1','title'=>'AppKey','cate'=>'5','cate_child'=>'13','extra'=>'','remark'=>'appid对应的密钥，访问用户资源时用来验证应用的合法性。在OAuth2.0认证过程中，appkey的值即为oauth_consumer_secret的值','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'0','append'=>'1495508092','updated'=>'1506756052']);
        $this->insert('{{%sys_config}}',['id'=>'99','name'=>'WEIXIN_CLIENT_APPID','type'=>'1','title'=>'AppId','cate'=>'5','cate_child'=>'13','extra'=>'','remark'=>'appid对应的密钥，访问用户资源时用来验证应用的合法性。在OAuth2.0认证过程中，appkey的值即为oauth_consumer_secret的值','status'=>'1','value'=>'','sort'=>'0','is_hide_remark'=>'0','append'=>'1495508028','updated'=>'1506756051']);
...
1:开启','remark'=>'修改后需要刷新后台才能看到效果','status'=>'1','value'=>'1','sort'=>'3','is_hide_remark'=>'0','append'=>'1501730637','updated'=>'1506492330']);
        $this->insert('{{%sys_config}}',['id'=>'112','name'=>'WECHAT_SHARE_COVER','type'=>'8','title'=>'分享图片','cate'=>'3','cate_child'=>'22','extra'=>'','remark'=>'','status'=>'1','value'=>NULL,'sort'=>'2','is_hide_remark'=>'1','append'=>'1506756118','updated'=>'1506756118']);
        $this->insert('{{%sys_config}}',['id'=>'106','name'=>'STORAGE_ALI_ACCESSKEYID','type'=>'1','title'=>'accessKeyId','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','status'=>'1','value'=>'','sort'=>'0','is_hide_remark'=>'1','append'=>'1506748040','updated'=>'1506756060']);
        $this->insert('{{%sys_config}}',['id'=>'107','name'=>'STORAGE_ALI_ACCESSKEYSECRET','type'=>'2','title'=>'accessKeySecret','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','status'=>'1','value'=>'','sort'=>'1','is_hide_remark'=>'1','append'=>'1506748120','updated'=>'1506756061']);
        $this->insert('{{%sys_config}}',['id'=>'108','name'=>'STORAGE_ALI_BUCKET','type'=>'1','title'=>'空间名','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','status'=>'1','value'=>'','sort'=>'2','is_hide_remark'=>'1','append'=>'1506748216','updated'=>'1506756062']);
        $this->insert('{{%sys_config}}',['id'=>'109','name'=>'STORAGE_ALI_ENDPOINT','type'=>'1','title'=>'EndPoint','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','status'=>'1','value'=>'','sort'=>'3','is_hide_remark'=>'1','append'=>'1506748837','updated'=>'1506756063']);
        $this->insert('{{%sys_config}}',['id'=>'110','name'=>'WECHAT_SHARE_TITLE','type'=>'1','title'=>'分享标题','cate'=>'3','cate_child'=>'22','extra'=>'','remark'=>'','status'=>'1','value'=>NULL,'sort'=>'0','is_hide_remark'=>'1','append'=>'1506755875','updated'=>'1506755875']);
        $this->insert('{{%sys_config}}',['id'=>'111','name'=>'WECHAT_SHARE_DETAILS','type'=>'4','title'=>'分享详情','cate'=>'3','cate_child'=>'22','extra'=>'','remark'=>'','status'=>'1','value'=>NULL,'sort'=>'1','is_hide_remark'=>'1','append'=>'1506755948','updated'=>'1506755952']);
        $this->insert('{{%sys_config}}',['id'=>'113','name'=>'WECHAT_SHARE_URL','type'=>'1','title'=>'分享链接','cate'=>'3','cate_child'=>'22','extra'=>'','remark'=>'','status'=>'1','value'=>NULL,'sort'=>'3','is_hide_remark'=>'1','append'=>'1506756192','updated'=>'1506756192']);
