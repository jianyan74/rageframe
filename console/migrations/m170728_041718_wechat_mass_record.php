...
class m170728_041718_wechat_mass_record extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%wechat_mass_record}}', [
            ...
            'group' => 'int(10) NULL COMMENT \'分组\'',
            'attach_id' => 'int(10) unsigned NULL',
            'media_id' => 'varchar(100) NULL',
            'type' => 'tinyint(3) unsigned NULL COMMENT \'类别\'',
            'status' => 'tinyint(3) unsigned NULL COMMENT \'发送状态\'',
