...
class m170919_082341_sys_desk_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%sys_desk_menu}}',['id'=>'1','cover'=>'','title'=>'测试','pid'=>'0','url'=>'123','menu_css'=>'','sort'=>'0','level'=>'1','status'=>'1','append'=>'1503479335','updated'=>'1503479443']);
