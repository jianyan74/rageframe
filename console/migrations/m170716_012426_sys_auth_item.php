...
class m170716_012426_sys_auth_item extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_rule_7382_00','{{%sys_auth_item}}', 'rule_name', '{{%sys_auth_rule}}', 'name', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'wechat/news/index','type'=>'2','key'=>'41','description'=>'素材库','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'36','level'=>'2','sort'=>'2','created_at'=>'1499591807','updated_at'=>NULL]);
