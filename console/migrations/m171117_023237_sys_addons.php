...
class m171117_023237_sys_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_addons}}', [
            ...
            'wxapp_support' => 'tinyint(4) NULL DEFAULT \'0\' COMMENT \'小程序支持 0不支持1支持\'',
        ...
        /* 表数据 */
        $this->insert('{{%sys_addons}}',['id'=>'76','name'=>'AppExample','title'=>'示例管理','cover'=>'','group'=>'','type'=>'plug','brief_introduction'=>'系统的功能示例','description'=>'系统自带的功能使用示例及其说明，包含一些简单的交互','config'=>NULL,'setting'=>'0','hook'=>'1','author'=>'简言','version'=>'1.0','title_initial'=>'S','wechat_message'=>'a:0:{}','is_rule'=>'0','wxapp_support'=>'0','status'=>'1','append'=>'1509345642','updated'=>'1509696024']);
