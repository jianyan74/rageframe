...
class m171027_034127_sys_auth_item extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_rule_0805_00','{{%sys_auth_item}}', 'rule_name', '{{%sys_auth_rule}}', 'name', 'CASCADE', 'CASCADE' );
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/article/edit','type'=>'2','key'=>'26','description'=>'编辑新增','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'19','level'=>'3','sort'=>'0','created_at'=>'1499590946','updated_at'=>'1507960240']);
        ...
        $this->insert('{{%sys_auth_item}}',['name'=>'sys/manager/personal','type'=>'2','key'=>'61','description'=>'个人中心','rule_name'=>NULL,'data'=>NULL,'parent_key'=>'60','level'=>'2','sort'=>'0','created_at'=>'1507982270','updated_at'=>NULL]);
