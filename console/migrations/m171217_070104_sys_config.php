...
class m171217_070104_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%sys_config}}', [
            ...
            'cate' => 'int(5) unsigned NOT NULL COMMENT \'配置分类\'',
        ...
        /* 表数据 */
        $this->insert('{{%sys_config}}',['id'=>'1','title'=>'网站标题','type'=>'text','name'=>'WEB_SITE_TITLE','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'网站标题前台显示标题','value'=>'RageFrame应用开发引擎','is_hide_remark'=>'0','sort'=>'0','status'=>'1','append'=>'1378898976','updated'=>'1507794515']);
        $this->insert('{{%sys_config}}',['id'=>'2','title'=>'SEO网站描述','type'=>'textarea','name'=>'WEB_SITE_DESCRIPTION','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'网站搜索引擎描述','value'=>'','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1378898976','updated'=>'1497239140']);
        $this->insert('{{%sys_config}}',['id'=>'3','title'=>'SEO网站关键字','type'=>'textarea','name'=>'WEB_SITE_KEYWORD','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'网站搜索引擎关键字,多个关键字以,号分割开 如: A,B.C','value'=>'','is_hide_remark'=>'0','sort'=>'5','status'=>'1','append'=>'1378898976','updated'=>'1497235269']);
...
1:开启','remark'=>'站点关闭全部用户不能访问','value'=>'1','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1378898976','updated'=>'1501730648']);
        $this->insert('{{%sys_config}}',['id'=>'5','title'=>'网站备案号','type'=>'text','name'=>'WEB_SITE_ICP','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'设置在网站底部显示的备案号，如“沪ICP备12007941号-2','value'=>'浙ICP备17025911号-2','is_hide_remark'=>'0','sort'=>'7','status'=>'1','append'=>'1378900335','updated'=>'1503385050']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'8','title'=>'网站版权所有','type'=>'text','name'=>'WEB_COPYRIGHT_ALL','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'设置在网站底部显示的版权所有','value'=>'© 2016 - 2017 RageFrame All Rights Reserved.','is_hide_remark'=>'0','sort'=>'6','status'=>'1','append'=>'1481591179','updated'=>'1499827750']);
        $this->insert('{{%sys_config}}',['id'=>'42','title'=>'是否开启','type'=>'radioList','name'=>'ALIPAY_WIRELESS','cate'=>'4','cate_child'=>'8','extra'=>'0:关闭,1:开启','remark'=>'支付宝账号必须支持手机网页即时到账接口, 才能使用手机支付功能,<a href=\"https://b.alipay.com/order/productDetail.htm?productId=2013080604609688\" target=\"_blank\">申请及详情请查看这里</a>','value'=>'0','is_hide_remark'=>'0','sort'=>'0','status'=>'1','append'=>'1481590972','updated'=>'1497231182']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'53','title'=>'AppId','type'=>'text','name'=>'WECHAT_APPID','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppId','value'=>'','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1481597992','updated'=>'1512438678']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'54','title'=>'AppSecret','type'=>'text','name'=>'WECHAT_APPSERCRET','cate'=>'3','cate_child'=>'19','extra'=>'','remark'=>'请填写微信公众平台后台的AppSecret, 只有填写这两项才能管理自定义菜单','value'=>'','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1481598058','updated'=>'1512438678']);
        $this->insert('{{%sys_config}}',['id'=>'55','title'=>'Token','type'=>'secretKeyText','name'=>'WECHAT_TOKEN','cate'=>'3','cate_child'=>'19','extra'=>'32','remark'=>'与公众平台接入设置值一致，必须为英文或者数字，长度为3到32个字符. 请妥善保管, Token 泄露将可能被窃取或篡改平台的操作数据.','value'=>'','is_hide_remark'=>'0','sort'=>'5','status'=>'1','append'=>'1481598165','updated'=>'1510109092']);
...
','value'=>'','is_hide_remark'=>'0','sort'=>'6','status'=>'1','append'=>'1481598229','updated'=>'1501465722']);
        $this->insert('{{%sys_config}}',['id'=>'61','title'=>'支付商户号','type'=>'text','name'=>'WECHAT_MCHID','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'公众号支付请求中用于加密的密钥Key','value'=>'','is_hide_remark'=>'0','sort'=>'1','status'=>'1','append'=>'1484010596','updated'=>'1512437818']);
        $this->insert('{{%sys_config}}',['id'=>'60','title'=>'是否开启','type'=>'radioList','name'=>'WECHAT_IS_PAY','cate'=>'4','cate_child'=>'9','extra'=>'0:关闭,1:开启','remark'=>'你必须向微信公众平台提交企业信息以及银行账户资料，审核通过并签约后才能使用微信支付功能,<a href=\"https://mp.weixin.qq.com/paymch/readtemplate?t=mp/business/faq_tmpl\" target=\"_blank\">申请及详情请查看这里</a>','value'=>'1','is_hide_remark'=>'0','sort'=>'0','status'=>'1','append'=>'1484010415','updated'=>'1506756040']);
        $this->insert('{{%sys_config}}',['id'=>'62','title'=>'支付密钥','type'=>'text','name'=>'WECHAT_API_KEY','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'此值需要手动在腾讯商户后台API密钥保持一致。','value'=>'','is_hide_remark'=>'0','sort'=>'2','status'=>'1','append'=>'1484010645','updated'=>'1512437818']);
        $this->insert('{{%sys_config}}',['id'=>'63','title'=>'支付证书','type'=>'text','name'=>'WECHAT_APICLIENT_CERT','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'请填写证书绝对路径','value'=>'','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1484012102','updated'=>'1506756044']);
        $this->insert('{{%sys_config}}',['id'=>'64','title'=>'支付证书私钥','type'=>'text','name'=>'WECHAT_APICLIENT_KEY','cate'=>'4','cate_child'=>'9','extra'=>'','remark'=>'请填写私钥绝对路径','value'=>'','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1484012169','updated'=>'1506756045']);
        $this->insert('{{%sys_config}}',['id'=>'69','title'=>'网站logo','type'=>'image','name'=>'WEB_SITE_LOGO','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'商标','value'=>'','is_hide_remark'=>'1','sort'=>'1','status'=>'1','append'=>'1486629289','updated'=>'1510722635']);
...
','remark'=>'每页显示记录的数量','value'=>'10','is_hide_remark'=>'0','sort'=>'0','status'=>'1','append'=>'1486631131','updated'=>'1497239638']);
        $this->insert('{{%sys_config}}',['id'=>'72','title'=>'网站访问量统计','type'=>'textarea','name'=>'WEB_VISIT_CODE','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'用于统计网站访问量的第三方代码','value'=>'','is_hide_remark'=>'0','sort'=>'8','status'=>'1','append'=>'1486952122','updated'=>'1497231351']);
...
2:不限','remark'=>'如果选择不限会显示全部菜单，选择有权限菜单则只会显示用户权限对应的菜单','value'=>'1','is_hide_remark'=>'0','sort'=>'2','status'=>'1','append'=>'1492360156','updated'=>'1501634806']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'101','title'=>'联系电话','type'=>'text','name'=>'WEB_TELEPHONE','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'','value'=>'','is_hide_remark'=>'1','sort'=>'2','status'=>'1','append'=>'1497180795','updated'=>'1497238306']);
        $this->insert('{{%sys_config}}',['id'=>'102','title'=>'联系QQ','type'=>'text','name'=>'WEB_RETATION_QQ','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'','value'=>'','is_hide_remark'=>'1','sort'=>'3','status'=>'1','append'=>'1497235256','updated'=>'1497238306']);
...
1:开启;','remark'=>'开启此项后，连接将用SSL的形式，此项需要SMTP服务器支持','value'=>'0','is_hide_remark'=>'0','sort'=>'4','status'=>'1','append'=>'1501212682','updated'=>'1510801616']);
        $this->insert('{{%sys_config}}',['id'=>'104','title'=>'百度自动推送','type'=>'textarea','name'=>'WEB_BAIDU_PUSH','cate'=>'1','cate_child'=>'17','extra'=>'','remark'=>'自动推送网站链接给百度收录','value'=>'','is_hide_remark'=>'0','sort'=>'9','status'=>'1','append'=>'1501466488','updated'=>'1501625204']);
...
1:开启','remark'=>'修改后需要刷新后台才能看到效果','value'=>'1','is_hide_remark'=>'0','sort'=>'3','status'=>'1','append'=>'1501730637','updated'=>'1506492330']);
        $this->insert('{{%sys_config}}',['id'=>'112','title'=>'分享图片','type'=>'image','name'=>'WECHAT_SHARE_COVER','cate'=>'3','cate_child'=>'22','extra'=>'','remark'=>'','value'=>NULL,'is_hide_remark'=>'1','sort'=>'2','status'=>'1','append'=>'1506756118','updated'=>'1506756118']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'108','title'=>'空间名','type'=>'text','name'=>'STORAGE_ALI_BUCKET','cate'=>'7','cate_child'=>'21','extra'=>'','remark'=>'','value'=>'','is_hide_remark'=>'1','sort'=>'2','status'=>'1','append'=>'1506748216','updated'=>'1506756062']);
