    ...
    <tr id = <?= $model['id']?>>
        ...
        <td>
            ...
            <?php if($model['level'] <= Yii::$app->config->info('SYS_MAX_LEVEL')){ ?>
                <a href="<?= Url::to(['edit','pid'=>$model['id'],'parent_title'=>$model['title'],'level'=>$model['level']+1])?>">
        ...
        <td>
            <a href="<?= Url::to(['edit','id'=>$model['id'],'parent_title'=>$parent_title])?>"><span class="btn btn-info btn-sm">编辑</span></a>&nbsp
