                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($models as $model){ ?>
                            <tr id = <?= $model->tag_id?>>
                                ...
                                <td>
                                    <a href="<?= Url::to(['edit','tag_id'=>$model->tag_id])?>"><span class="btn btn-info btn-sm">编辑</span></a>&nbsp
                                    ...
                                    <a href="<?= Url::to(['delete','tag_id'=>$model->tag_id])?>" onclick="deleted(this);return false;"><span class="btn btn-warning btn-sm">删除</span></a>&nbsp
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
