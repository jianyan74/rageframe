                                ...
                                <?= $form->field($model,'provinces')->dropDownList(Provinces::getCityList(),
                                    [
                                        ...
                                        'onchange'  =>'
                                                            ...
                                                            $.post("'.yii::$app->urlManager->createUrl('sys/provinces/index').'?typeid=1&pid="+$(this).val(),function(data){
                                                                $("select#manager-city").html(data);
                                                            });',
                                    ]) ?>
                            </div>
                            <div class="col-md-4">
                                <?= $form->field($model, 'city')->dropDownList(Provinces::getCityList($model->provinces),
                                    [
                                        ...
                                        'onchange'  =>'
                                                            ...
                                                            $.post("'.yii::$app->urlManager->createUrl('sys/provinces/index').'?typeid=2&pid="+$(this).val(),function(data){
                                                                $("select#manager-area").html(data);
                                                            });',
                                    ]) ?>
                            </div>
                            <div class="col-md-4">
