...
/**
 * Class AdvLocationController
 * @package backend\controllers
 * 广告位
 */
class AdvLocationController extends Addons
{
    /**
     * 首页
     */
    ...
    protected function findModel($id)
    {
        if (empty($id))
        {
            $model = new AdvLocation;
            return $model->loadDefaultValues();
        }

        if (empty(($model = AdvLocation::findOne($id))))
        {
            return new AdvLocation;
        }
